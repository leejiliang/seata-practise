 ...
 */
@Configuration
@MapperScan(basePackages = "com.seata.util.mapper", sqlSessionFactoryRef = "sqlSessionFactory")
...
public class MybatisPlusConfig {
    ...
    public MybatisSqlSessionFactoryBean sqlSessionFactory(DataSource dynamicDataSource){
        ...
        // mapper.xml别名映射
        sqlSessionFactoryBean.setTypeAliasesPackage("com.seata.util.entity");
